parameters = [
  {name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.kruthikadevops.site:80/"},
  {name = "dev.frontend.cart_url", value = "http://cart-dev.kruthikadevops.site:80/"},
  {name = "dev.frontend.user_url", value = "http://user-dev.kruthikadevops.site:80/"},
  {name = "dev.frontend.shipping_url", value = "http://shipping-dev.kruthikadevops.site:80/"},
  {name = "dev.frontend.payment_url", value = "http://payment-dev.kruthikadevops.site:80/"},
  {name = "dev.catalogue.mongo_endpoint", value = "mongodb-dev.kruthikadevops.site"},
  {name = "dev.catalogue.mongo", value = "DOCUMENTDB=true"},
  {name = "dev.user.mongo", value = "DOCUMENTDB=true"},
  {name = "dev.user.redis", value = "elasitcache-dev-elasticache.vy9ngr.ng.0001.use1.cache.amazonaws.com"},
  {name = "dev.cart.redis", value = "elasitcache-dev-elasticache.vy9ngr.ng.0001.use1.cache.amazonaws.com"},
  {name = "dev.cart.catalogue_host", value = "catalogue-dev.kruthikadevops.site" },
  ...
  {name = "dev.shipping.cart_host", value = "cart-dev.kruthikadevops.site:80" },
  {name = "dev.shipping.mysql_user", value = "root" },
  {name = "dev.payment.cart_host", value = "cart-dev.kruthikadevops.site" },
  {name = "dev.payment.cart_port", value = "80" },
  {name = "dev.payment.user_host", value = "user-dev.kruthikadevops.site" },
  {name = "dev.payment.user_port", value = "80" },
  {name = "dev.payment.rabbitmq_host", value = "rabbitmq-dev.kruthikadevops.site" },
